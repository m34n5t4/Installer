...
sleep 1
pkg install git php python2 cowsay figlet toilet ruby
gem install lolcat
pip2 install toilet
pip2 install lolcat
pkg install php
...
then
clear
echo -e $green" installing tool Mr.Rv1.1 "
sleep 1
pkg install gem
pkg install figlet
gem install lolcat
...
then
clear
echo -e $green" installing B4J1N94Nv5 "
sleep 1
...
then
clear
echo -e $green" installing TU4NB4DUT "
sleep 1
...
then
clear
echo -e $green" installing HACK FB "
sleep 1
pkg install nano python2 cowsay git
pip2 install lolcat
...
then
clear
echo -e $green" installing LazyGo "
sleep 1
